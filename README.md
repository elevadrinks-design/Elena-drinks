Eleva Drinks 💪
A mobile-first ordering web app for Eleva Drinks (Fresh Juice & Protein Shakes). Built with vanilla HTML / CSS / JavaScript — no frameworks, no backend, no build tools required.
